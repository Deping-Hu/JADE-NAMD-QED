...
class generate_many_x_descriptor():
    ...
    def many_x(self):
#delete this in predication process
#        command = 'rm dih3124_all.dat'
#        os.system(command)
##############
...
#delete this in predication process
#            command = '/home/dhu13/Program/JADE_NAMD_mu_learn/contrib/geom_worker.py -d 3 1 2 4 ' + str(single_filename) + ' | tail -n 1 | awk \'{print $2}\' >> dih3124_all.dat' 
#            os.system(command)
##################
...
#delete this in predication process
#        np.savetxt('coulomb_input_tmp.dat', x_old)
#        command = 'paste coulomb_input_tmp.dat dih3124_all.dat > coulomb_input.dat'
#        os.system(command)
####
