      ...
      integer, intent(in) :: n_atom, it, n_state, n_state_ele,index_state
!      integer, intent(in) :: file_save_traj, file_save_vel
      ...
      write (100, *) "------------------------------"
      write (100, *) "Total number of total state is", n_state
      write (100, *) "Total number of electronic state is", n_state_ele
