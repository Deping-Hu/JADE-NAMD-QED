      ...
      integer, intent(in) :: n_atom, qm_method, n_state, n_state_ele, label_no_nac, label_ml_pes
      double precision, intent(in) :: time
      integer, intent(in) :: file_md_out, file_save_dipole, file_save_mu, &
                             index_state, it
     ...
     allocate(mu_x(n_state,n_state))
     allocate(mu_y(n_state,n_state))
     allocate(mu_z(n_state,n_state))
